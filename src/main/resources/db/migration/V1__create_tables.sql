...
-- Menu items indexes
CREATE INDEX idx_menu_items_categories ON menu_item(category_id);
CREATE INDEX idx_menu_items_available ON menu_item(available);
CREATE INDEX idx_menu_items_price ON menu_item(price);
...
CREATE INDEX idx_order_items_status ON order_item(status);
